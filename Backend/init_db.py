...
def initialize_db():
    ...
    with app.app_context():
        ...
        if Route.query.count() == 0:
            ...
            st1 = Stop(route_id=r1.route_id, stop_name='Gajuwaka', lat=17.7004, lng=83.2168, stop_order=1)
            st2 = Stop(route_id=r1.route_id, stop_name='Maddilapalem', lat=17.7382, lng=83.3230, stop_order=2)
            st3 = Stop(route_id=r1.route_id, stop_name='Beach Road', lat=17.7141, lng=83.3236, stop_order=3)
            # Stops (Route 2: Maddilapalem → Simhachalam)
            st6 = Stop(route_id=r2.route_id, stop_name='Maddilapalem', lat=17.7382, lng=83.3230, stop_order=1)
            st7 = Stop(route_id=r2.route_id, stop_name='NAD Junction', lat=17.7495, lng=83.2030, stop_order=2)
            st8 = Stop(route_id=r2.route_id, stop_name='Simhachalam', lat=17.7736, lng=83.2484, stop_order=3)
            # Stops (Route 3: RTC Complex → Railway Station)
            st4 = Stop(route_id=r3.route_id, stop_name='RTC Complex', lat=17.7237, lng=83.3072, stop_order=1)
            st5 = Stop(route_id=r3.route_id, stop_name='Railway Station', lat=17.7222, lng=83.2897, stop_order=2)
